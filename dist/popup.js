...
async function exportToObsidian() {
  try {
    ...
    // Create the Obsidian URL using append instead of new
    const obsidianUrl = `obsidian://append?vault=${encodeURIComponent(obsidianVault)}&file=${encodeURIComponent(obsidianNote)}&data=${encodedContent}`;
